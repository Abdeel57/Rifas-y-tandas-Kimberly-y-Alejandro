...
async function bootstrap() {
  ...
  const allowedOrigins = [
    ...
    'http://rifasytandaskya.com',
    'http://www.rifasytandaskya.com',
    // Dominio Netlify (mantener para desarrollo)
  ...
  app.getHttpAdapter().get('/', (req, res) => {
    res.json({
      message: 'Rifas y tandas Kimberly y Alejandro - Backend API',
      status: 'running',
      version: '1.0.0',
      endpoints: {
        api: '/api',
  ...
  console.log(`🚀 Rifas y tandas Kimberly y Alejandro - Backend starting...`);
